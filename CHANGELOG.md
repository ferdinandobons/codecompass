...
- **README rewritten** with stronger positioning and clearer value proposition
  - New tagline: "Give your AI coding assistant a map of your codebase, not a blindfold"
  - Added "Why Kontexto?" comparison table vs traditional tools
  - Before/after code examples showing token efficiency
  - Reorganized structure: problem → solution → value → usage

### Docs

- **CLAUDE.md** updated with GitHub release creation process
...
[0.2.1]: https://github.com/ferdinandobons/kontexto/releases/tag/v0.2.1
